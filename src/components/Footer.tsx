...
const footerLinks = {
  ...
  reference: {
    ...
    links: [
      { name: "Primary Agents", href: "/reference/agents/primary" },
      { name: "Sub-Agents", href: "/reference/agents/sub" },
      { name: "Meta-Skills", href: "/reference/skills?type=meta" },
      { name: "Skills", href: "/reference/skills?type=regular" },
      { name: "Scaffolds", href: "/reference/scaffolds" },
      { name: "Agent Templates", href: "/reference/agent-templates" },
      { name: "MCP Servers", href: "/reference/mcp" },
      { name: "Automations", href: "/reference/automations" },
    ],
  },
  gettingStarted: {
