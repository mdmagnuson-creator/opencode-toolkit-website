...
const concepts = [
  ...
  },
  {
    ...
    subLinks: [
      { name: "How It Works", href: "/concepts/vectorization#how-it-works" },
      { name: "Setup Guide", href: "/concepts/vectorization#setup" },
      { name: "CLI Commands", href: "/concepts/vectorization#cli-commands" },
    ],
    icon: (
      <svg
        className="h-6 w-6"
