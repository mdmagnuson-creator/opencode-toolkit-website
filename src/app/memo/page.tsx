      ...
      <div className="px-6 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-3xl">
          ...
          <article className="prose prose-neutral max-w-none dark:prose-invert prose-headings:tracking-tight prose-p:leading-7 prose-a:text-blue-600 dark:prose-a:text-blue-400">
            ...
            <p>
              For most of history, building software required knowing how to build software. The constraint was knowledge: understanding languages, frameworks, patterns, and the accumulated wisdom of decades of engineering practice. Those who possessed this knowledge created; those who didn&apos;t requested and waited.
            </p>
            <p>
          ...
          {/* Attribution */}
          <aside id="attribution" className="mt-16 border-t border-neutral-200 pt-8 dark:border-neutral-800">
