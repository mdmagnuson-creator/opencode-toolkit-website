    ...
    <main className="min-h-screen">
      ...
      <section className="flex min-h-screen flex-col items-center justify-center px-6 py-24 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-3xl text-center">
          ...
          {/* Stats */}
          <div className="mt-16 grid grid-cols-3 gap-8 border-t border-neutral-200 pt-10 dark:border-neutral-800">
            <div>
              <p className="text-3xl font-semibold tracking-tight text-neutral-900 sm:text-4xl dark:text-neutral-50">
                57
              </p>
      ...
      {/* Getting Started Section Anchor (placeholder for future stories) */}
      <section id="getting-started" className="min-h-[50vh] px-6 py-24">
        <div className="mx-auto max-w-3xl text-center">
