      ...
      <section className="border-t border-neutral-200 px-6 py-12 sm:px-8 lg:px-12 dark:border-neutral-800">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {/* Probe Hardening */}
            <a href="/concepts/agent-workflows#playwright-analysis-probe" className="rounded-xl border border-neutral-200 bg-white p-5 transition-colors hover:border-neutral-300 hover:bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900 dark:hover:border-neutral-600 dark:hover:bg-neutral-800">
              ...
              <h3 className="mt-3 text-sm font-semibold text-neutral-900 dark:text-neutral-50">Probe Hardening</h3>
              <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">Playwright probes can no longer be bypassed — no-bypass rule blocks common rationalizations.</p>
            </a>
            {/* Autonomous Auth */}
            <a href="/concepts/agent-workflows#playwright-analysis-probe" className="rounded-xl border border-neutral-200 bg-white p-5 transition-colors hover:border-neutral-300 hover:bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900 dark:hover:border-neutral-600 dark:hover:bg-neutral-800">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-teal-100 dark:bg-teal-900">
                {/* Key icon */}
                <svg className="h-4 w-4 text-teal-700 dark:text-teal-300" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25a3 3 0 013 3m3 0a6 6 0 01-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.17.659-1.591l6.499-6.499c.404-.404.527-1 .43-1.563A6 6 0 1121.75 8.25z" />
                </svg>
              </div>
              <h3 className="mt-3 text-sm font-semibold text-neutral-900 dark:text-neutral-50">Autonomous Auth</h3>
              <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">Builder resolves authentication autonomously via escalation ladder — never asks for credentials.</p>
            </a>
            {/* Session Unification */}
            <a href="/concepts/agent-workflows#unified-state-model" className="rounded-xl border border-neutral-200 bg-white p-5 transition-colors hover:border-neutral-300 hover:bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900 dark:hover:border-neutral-600 dark:hover:bg-neutral-800">
              ...
              <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">Single activeWork object replaces separate PRD/ad-hoc state — stories, decisions, and resume all in one place.</p>
            </a>
            {/* Agent Consolidation */}
            <a href="/concepts/testing#test-verify-settings" className="rounded-xl border border-neutral-200 bg-white p-5 transition-colors hover:border-neutral-300 hover:bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900 dark:hover:border-neutral-600 dark:hover:bg-neutral-800">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-cyan-100 dark:bg-cyan-900">
                {/* Beaker icon */}
                <svg className="h-4 w-4 text-cyan-700 dark:text-cyan-300" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 00-6.23.693L5 14.5m14.8.8l1.402 1.402c1.232 1.232.65 3.318-1.067 3.611A48.309 48.309 0 0112 21c-2.773 0-5.491-.235-8.135-.687-1.718-.293-2.3-2.379-1.067-3.61L5 14.5" />
                </svg>
              </div>
              <h3 className="mt-3 text-sm font-semibold text-neutral-900 dark:text-neutral-50">Agent Consolidation</h3>
              <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">E2E agents renamed to UI testing names, playwright-dev merged into ui-tester-playwright, plus new testVerifySettings for fine-grained Playwright control.</p>
            </a>
          </div>
        </div>
      </section>
