...
export const metadata: Metadata = {
  ...
  description: "63 AI agents and 66 specialized skills working together to build software. Plan features with PRDs, implement with Builder, and ship production-ready code. An agent system for opencode.",
  openGraph: {
    title: "yo, go — AI Agents for Software Development",
    description: "63 AI agents and 66 specialized skills working together to build software. Plan features with PRDs, implement with Builder, and ship production-ready code.",
    images: ["/og/home.png"],
  },
};
      ...
      <section className="border-t border-neutral-200 px-6 py-12 sm:px-8 lg:px-12 dark:border-neutral-800">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {/* testVerifySettings */}
            <a href="/concepts/testing#test-verify-settings" className="rounded-xl border border-neutral-200 bg-white p-5 transition-colors hover:border-neutral-300 hover:bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900 dark:hover:border-neutral-600 dark:hover:bg-neutral-800">
              ...
              <h3 className="mt-3 text-sm font-semibold text-neutral-900 dark:text-neutral-50">testVerifySettings</h3>
              <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">Six booleans are now the sole Playwright gate — replaces testIntensity, storyAssessment, rigorProfile, and E2E deferral.</p>
            </a>
            {/* Verification State Reset */}
            <a href="/concepts/testing#verification-loop" className="rounded-xl border border-neutral-200 bg-white p-5 transition-colors hover:border-neutral-300 hover:bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900 dark:hover:border-neutral-600 dark:hover:bg-neutral-800">
              ...
              <h3 className="mt-3 text-sm font-semibold text-neutral-900 dark:text-neutral-50">Verification State Reset</h3>
              <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">Stale verification contracts no longer carry over between tasks — state resets at every task boundary.</p>
            </a>
            {/* OAuth Diagnostic Skill */}
            <a href="/skills/oauth-callback-diagnostic" className="rounded-xl border border-neutral-200 bg-white p-5 transition-colors hover:border-neutral-300 hover:bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900 dark:hover:border-neutral-600 dark:hover:bg-neutral-800">
              ...
              <h3 className="mt-3 text-sm font-semibold text-neutral-900 dark:text-neutral-50">OAuth Diagnostic Skill</h3>
              <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">New skill diagnoses OAuth redirect_uri mismatches across any provider and app type — desktop and web.</p>
            </a>
            {/* Unified State Model */}
            <a href="/concepts/agent-workflows#unified-state-model" className="rounded-xl border border-neutral-200 bg-white p-5 transition-colors hover:border-neutral-300 hover:bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-900 dark:hover:border-neutral-600 dark:hover:bg-neutral-800">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-violet-100 dark:bg-violet-900">
                {/* Document icon */}
                <svg className="h-4 w-4 text-violet-700 dark:text-violet-300" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                </svg>
              </div>
              <h3 className="mt-3 text-sm font-semibold text-neutral-900 dark:text-neutral-50">Unified State Model</h3>
              <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">Single activeWork object replaces separate PRD and ad-hoc state — stories, decisions, and resume all in one place.</p>
            </a>
          </div>
        </div>
      </section>
