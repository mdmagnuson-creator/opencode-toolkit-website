...
export default function McpPage() {
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <ul className="mt-3 space-y-1 text-sm text-green-800 dark:text-green-400">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1 text-green-600 dark:text-green-500">•</span>
                  <span><strong>Documentation lookup:</strong> Uses documentation tools if available, otherwise upstream docs</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1 text-green-600 dark:text-green-500">•</span>
  ...
  "enabled": true
      ...
      <div className="mt-16 flex items-center justify-between border-t border-neutral-200 pt-8 dark:border-neutral-800">
        <a href="/reference/scaffolds" className="group flex items-center gap-2 text-neutral-600 transition-colors hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-100">
          <svg className="h-5 w-5 transition-transform group-hover:-translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
          </svg>
          <span>Scaffolds</span>
        </a>
        <a href="/reference/automations" className="group flex items-center gap-2 text-neutral-600 transition-colors hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-100">
