...
// Changelog data from the toolkit manifest (sourced from changelog.entries)
const changelog: ChangelogDay[] = manifest.changelog;

function TypeBadge({ type }: { type: ChangelogEntry["type"] }) {
  const styles: Record<ChangelogEntry["type"], string> = {
  ...
  const labels: Record<ChangelogEntry["type"], string> = {
    feat: "Feature",
    fix: "Fix",
    refactor: "Refactor",
    docs: "Docs",
